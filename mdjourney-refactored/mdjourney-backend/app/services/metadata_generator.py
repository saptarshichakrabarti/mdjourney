...
class MetadataGenerator:
    ...
    def __init__(self, schema_manager=None, vc_manager=None) -> None:
    ...
    def generate_project_file(self, project_path: str) -> Optional[str]:
        ...
        try:
            if not self.schema_manager:
                logger.error("Schema manager not available")
                return None
    ...
    def create_experiment_contextual_template(
        ...
        Args:
            ...
            template_type: Optional template type (e.g., 'microscopy_imaging', 'genomics_sequencing')
...
def create_experiment_contextual_template(
    ...
    """Create experiment contextual template."""
    return get_metadata_generator().create_experiment_contextual_template(
        dataset_path, experiment_id, template_type
    )
...
def generate_complete_metadata_file(
    ...
    """Generate complete metadata file."""
    return get_metadata_generator().generate_complete_metadata_file(dataset_path, experiment_id)
